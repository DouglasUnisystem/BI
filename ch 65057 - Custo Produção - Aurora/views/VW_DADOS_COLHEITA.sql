CREATE MATERIALIZED VIEW VW_DADOS_COLHEITA REFRESH FORCE ON DEMAND START WITH TO_DATE('10-02-2021 11:44:56', 'DD-MM-YYYY HH24:MI:SS') NEXT SYSDATE + 1/24/60 AS
