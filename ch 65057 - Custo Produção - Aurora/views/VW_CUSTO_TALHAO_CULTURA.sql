CREATE MATERIALIZED VIEW VW_CUSTO_TALHAO_CULTURA REFRESH FORCE ON DEMAND START WITH TO_DATE('18-03-2021 16:07:23', 'DD-MM-YYYY HH24:MI:SS') NEXT SYSDATE + 10/24/60 AS
