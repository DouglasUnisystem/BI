...
SELECT DISTINCT EM.COD_EMPRESA, GE.COD_FILIAL, GE.COD_SAFRA,
        ...
        TC.DESC_CULTURA,
        DECODE(NVL(GR.SEMENTE,'N'),'S','SEMENTE',DECODE(NVL(GR.FERTILIZANTE,'N'),'S','FERTILIZANTE',DECODE(NVL(GR.DEFENSIVO,'N'),'S','DEFENSIVO','OUTROS'))) DESCRICAO_GRUPO
...
SELECT DISTINCT EM.COD_EMPRESA, GE.COD_FILIAL, GE.COD_SAFRA,
  ...
  WHERE GP.COD_TABELA        = GE.COD_TABELA
    ...
    AND GP.DEBITO_CREDITO    = 'C'
    AND GE.SEQ_PLA_MOV_FIN IS NULL
--CR SEM ORIGEM, OU SEJA, NÃO TEM PRODUTO NA TIPO_CULTURA
UNION ALL
SELECT DISTINCT EM.COD_EMPRESA, GE.COD_FILIAL, GE.COD_SAFRA,
        EM.NOME_EMPRESA,
        GP.SEQ_PLANILHA AS SEQ_PLA_CONTA,
