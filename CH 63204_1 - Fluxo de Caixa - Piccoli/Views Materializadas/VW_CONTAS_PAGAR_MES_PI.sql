CREATE MATERIALIZED VIEW VW_CONTAS_PAGAR_MES_PI REFRESH FORCE ON DEMAND START WITH TO_DATE('29-12-2020 10:08:44', 'DD-MM-YYYY HH24:MI:SS') NEXT SYSDATE + 5/24/60 AS
