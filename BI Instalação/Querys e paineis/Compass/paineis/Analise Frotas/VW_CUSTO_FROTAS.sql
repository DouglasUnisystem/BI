      ...
      CASE WHEN PA.TIPO_BEM = 'P' THEN 'Proprio'
       ...
       PG.DESCRICAO||' - '||PG.CLASSIFICACAO AS DESC_GRUPO,
        NVL((SELECT
              SUM(EI.QUANTIDADE)
         FROM
              AGNEW.EST_ENTRADAS E ,
              AGNEW.EST_ENTRADAS_ITENS EI,
              AGNEW.EST_DEVOLUCAO_CONSUMO ED
         WHERE
         ...
         ES.SEQ_PLA_FAZENDA,
         FAZ.DESC_FAZENDA
  FROM AGNEW.EST_SAIDAS_CONSUMO ESC,
       AGNEW.EST_SAIDAS ES,
       AGNEW.EST_SAIDAS_ITENS ESI,
       AGNEW.PRODUTOS PR,
       AGNEW.MARCA_PRODUTO MP,
       AGNEW.FILIAIS    FI,
       AGNEW.SAFRAS     SA,
       ...
       AGNEW.PV_CCUSTO PC,
       AGNEW.ALM_USUARIOS  US,
       AGNEW.ALM_USUARIOS  UR,
       AGNEW.TAREFAS_CONSUMO TA,
       AGNEW.FAZENDAS FAZ,
       (SELECT LG.SEQ_PLA_SAIDA,
               CT.VALOR
          FROM AGNEW.LIGA_TEMPO_USO_EST_SAIDA LG,
               AGNEW.CTU_MOVIMENTACAO CT
...
WHERE SEQ_PLA_PATRIMONIO IS NOT NULL;
