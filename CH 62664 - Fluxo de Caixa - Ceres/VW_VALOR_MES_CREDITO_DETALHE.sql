CREATE OR REPLACE VIEW VW_VALOR_MES_CREDITO_DETALHE AS
SELECT CR.DOCUMENTO,
       CR.DATA_LCTO,
       PC.NOME_CONTA,
       CE.ENDERECO,
 ...
 WHERE 1 = 1
   ...
   --AND NVL(FH.ADIANTAMENTO,'N')                   = 'N'--PARA LANÇAAMENTOS BAIXADOS PODE CONSIDERAR (COMENTADO)
   --AND UPPER(NVL(CR.FORM_LANCAMENTO,'AAA'))      <> 'DFMCTRSAIDACORRETOR' --PARA LANÇAAMENTOS BAIXAIDOS PODE CONSIDERAR (COMENTADO)
