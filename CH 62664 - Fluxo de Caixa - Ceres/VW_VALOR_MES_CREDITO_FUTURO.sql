CREATE OR REPLACE VIEW VW_VALOR_MES_CREDITO_FUTURO AS
SELECT (SUM(NVL(CR.VALOR_DOCUM,0)) + SUM(NVL(CR.VALOR_JUROS,0)) - SUM(NVL(CR.VALOR_DESCONTO,0))) AS VALOR_CREDITO,
 ...
 WHERE 1 = 1
   ...
   AND CR.SEQ_PLA_RECEBER   NOT IN (SELECT SEQ_PLA_RECEBER FROM AGRICOLA.RECEBER_PAGTOS RP WHERE RP.SEQ_PLA_RECEBER = CR.SEQ_PLA_RECEBER)
